...
import 'package:agromind/screens/esp32_stream_screen/esp32_stream_screen.dart';
...
import 'package:agromind/screens/prediction_history_screen/prediction_history_screen.dart';
...
import 'bindings/prediction_history_binding/prediction_history_binding.dart';
  ...
  Widget build(BuildContext context) {
    return GetMaterialApp(
      ...
      getPages: [
        ...
        GetPage(name: "/esp32-stream", page: () => ESP32StreamScreen(esp32Ip: '',)),
        GetPage(name: '/prediction-history', page: () => PredictionHistoryScreen(), binding: PredictionHistoryBinding()),
      ],
    );
  }
}